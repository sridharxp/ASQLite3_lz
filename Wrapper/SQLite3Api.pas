...
type
  xToken_callback = function (pCtx : Psqlite3_context; tflags : Integer; const pToken :
    PUtf8Char; nToken : Integer; iStart : Integer; iEnd : Integer) : Integer; cdecl;
  ...
  Fts5ExtensionApi = record
    ...
    xTokenize: function(pContext: PFts5Context; const pText: PUTF8Char; nText: Integer; pCtx: Psqlite3_context; xToken: xToken_callback): Integer; cdecl;
    ...
    xTokenize_v2: function(p1: PFts5Context; const pText: PUTF8Char; nText: Integer; const pLocale: PUTF8Char; nLocale: Integer; pCtx: Pointer; xToken: { TODO : Create a procedural type for this parameter }
    Pointer): Integer; cdecl;
  end;
  ...
  fts5_tokenizer_v2 = record
    ...
    xTokenize: function(p1: PFts5Tokenizer; pCtx: Pointer; flags: Integer; const pText: PUTF8Char; nText: Integer; const pLocale: PUTF8Char; nLocale: Integer; xToken: { TODO : Create a procedural type for this parameter }
    Pointer): Integer; cdecl;
  end;
  ...
  fts5_tokenizer = record
    xCreate: function(p1: Pointer; azArg: PPUTF8Char; nArg: Integer; ppOut: PPFts5Tokenizer): Integer; cdecl;
    xDelete: procedure(p1: PFts5Tokenizer); cdecl;
    xTokenize: function(p1: PFts5Tokenizer; pCtx: Pointer; flags: Integer; const pText: PUTF8Char; nText: Integer; xToken: xToken_callback): Integer; cdecl;
  end;
...
type
  ...
  fts5_api = record
    iVersion: Integer;
    xCreateTokenizer: function(pApi: Pfts5_api; const zName: PUTF8Char; pUserData: Pointer; pTokenizer: Pfts5_tokenizer; xDestroy: { TODO : Create a procedural type for this parameter }
    Pointer): Integer; cdecl;
    ...
    xCreateFunction: function(pApi: Pfts5_api; const zName: PUTF8Char; pUserData: Pointer; xFunction: fts5_extension_function; xDestroy: { TODO : Create a procedural type for this parameter }
    Pointer): Integer; cdecl;
    xCreateTokenizer_v2: function(pApi: Pfts5_api; const zName: PUTF8Char; pUserData: Pointer; pTokenizer: Pfts5_tokenizer_v2; xDestroy: { TODO : Create a procedural type for this parameter }
    Pointer): Integer; cdecl;
...
type
  Tsqlite3_exec_callback = function(pArg: Pointer; nCol: Integer; azVals: PPUTF8Char; azCols: PPUTF8Char): Integer; cdecl;

function sqlite3_exec(p1: Psqlite3; const sql: PUTF8Char; callback: Tsqlite3_exec_callback; p4: Pointer; errmsg: PPUTF8Char): Integer; cdecl;
...
type
  Tsqlite3_busy_callback = function(ptr: Pointer; invoked: Integer): Integer; cdecl;

function sqlite3_busy_handler(db: Psqlite3; callback: Tsqlite3_busy_callback; p3: Pointer): Integer; cdecl;
...
type
  TSQLite3_SetAuthorizer_Callback = function(pAuthArg: Pointer; action_code: Integer;
    const zArg1: PUTF8Char; const zArg2: PUTF8Char; const zArg3: PUTF8Char;
	const zArg4: PUTF8Char): Integer; cdecl;

function sqlite3_set_authorizer(p1: Psqlite3; xAuth: TSQLite3_SetAuthorizer_Callback; pUserData: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3_set_authorizer';

type
  Tsqlite3_trace_callback = procedure(statement: Pointer; const text: PUTF8Char); cdecl;

function sqlite3_trace(p1: Psqlite3; xTrace: Tsqlite3_trace_callback; p3: Pointer): Pointer; cdecl;
  external bj name _PU + 'sqlite3_trace';

type
  Tsqlite3_profile_callback = procedure(statement: Pointer; const text: PUTF8Char; p3: sqlite3_uint64); cdecl;

function sqlite3_profile(p1: Psqlite3; xProfile: Tsqlite3_profile_callback; p3: Pointer): Pointer; cdecl;
  external bj name _PU + 'sqlite3_profile';

type
  Tsqlite3_tracev2_callback = function(invoked: Cardinal; context: Pointer; depend1: Pointer; depend2: Pointer): Integer; cdecl;

function sqlite3_trace_v2(p1: Psqlite3; uMask: Cardinal;
  xCallback: Tsqlite3_tracev2_callback; pCtx: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3_trace_v2';

type
  Tsqlite3_progress_callback = function(pArg: Pointer): Integer; cdecl;

procedure sqlite3_progress_handler(p1: Psqlite3; p2: Integer; p3: Tsqlite3_progress_callback; p4: Pointer); cdecl;
...
function sqlite3_stmt_explain(pStmt: Psqlite3_stmt; eMode: Integer): Integer; cdecl;
  external bj name _PU + 'sqlite3_stmt_explain';
function sqlite3_stmt_busy(p1: Psqlite3_stmt): Integer; cdecl;
  external bj name _PU + 'sqlite3_stmt_busy';

type
  Tsqlite3_bind_destructor = Tsqlite3_destructor_type;

function sqlite3_bind_blob(p1: Psqlite3_stmt; p2: Integer; const p3: Pointer; n: Integer; p5: Tsqlite3_bind_destructor): Integer; cdecl;
  external bj name _PU + 'sqlite3_bind_blob';


function sqlite3_bind_blob64(p1: Psqlite3_stmt; p2: Integer; const p3: Pointer; p4: sqlite3_uint64; p5: Tsqlite3_bind_destructor): Integer; cdecl;
...
function sqlite3_bind_text(p1: Psqlite3_stmt; p2: Integer; const p3: PUTF8Char; p4: Integer; p5: Tsqlite3_bind_destructor): Integer; cdecl;
  external bj name _PU + 'sqlite3_bind_text';


function sqlite3_bind_text16(p1: Psqlite3_stmt; p2: Integer; const p3: Pointer; p4: Integer; p5: Tsqlite3_bind_destructor): Integer; cdecl;
...
function sqlite3_bind_pointer(p1: Psqlite3_stmt; p2: Integer; p3: Pointer; const p4: PUTF8Char; p5: Tsqlite3_bind_destructor): Integer; cdecl;
...
type
  TSQLite3_Func_Callback = procedure(context: Psqlite3_context; argc: Integer; argv: PPsqlite3_value); cdecl;

type
  TSQLite3_Step_Callback = procedure(context: Psqlite3_context; argc: Integer; argv: PPsqlite3_value); cdecl;

type
  TSQLite3_Final_Callback = procedure(context: Psqlite3_context); cdecl;

function sqlite3_create_function(db: Psqlite3; const zFunctionName: PUTF8Char; nArg: Integer; eTextRep: Integer; pApp: Pointer;
...
function sqlite3_create_function16(db: Psqlite3; const zFunctionName: Pointer; nArg: Integer; eTextRep: Integer; pApp: Pointer;
 xFunc: TSQLite3_Func_Callback; xStep: TSQLite3_Step_Callback;
  xFinal: TSQLite3_Final_Callback): Integer; cdecl;
...
type
  TSQLite3_Destroy_Callback = Tsqlite3_destructor_type;

function sqlite3_create_function_v2(db: Psqlite3; const zFunctionName: PUTF8Char; nArg: Integer; eTextRep: Integer; pApp: Pointer;
 xFunc: TSQLite3_Func_Callback; xStep: TSQLite3_Step_Callback; xFinal:
  TSQLite3_Final_Callback; xDestroy: TSQLite3_Destroy_Callback): Integer; cdecl;
  external bj name _PU + 'sqlite3_create_function_v2';



type
  TSQLite3_value_callback = procedure(context: Psqlite3_context); cdecl;

type
  TSQLite3_inverse_callback = procedure(context: Psqlite3_context; argc: Integer; argv: PPsqlite3_value); cdecl;


function sqlite3_create_window_function(db: Psqlite3; const zFunctionName: PUTF8Char;
  nArg: Integer; eTextRep: Integer; pApp: Pointer; xStep: TSQLite3_step_callback; xFinal:
  TSQLite3_Final_Callback; xValue: TSQLite3_value_callback; xInverse: TSQLite3_inverse_callback;
  xDestroy: TSQLite3_Destroy_Callback): Integer; cdecl;
...
type
  Tsqlite3_delete_callback = Tsqlite3_destructor_type;

procedure sqlite3_set_auxdata(p1: Psqlite3_context; N: Integer; p3: Pointer; p4: Tsqlite3_delete_callback); cdecl;
  external bj name _PU + 'sqlite3_set_auxdata';
function sqlite3_get_clientdata(p1: Psqlite3; const p2: PUTF8Char): Pointer; cdecl;
  external bj name _PU + 'sqlite3_get_clientdata';
type
...
function sqlite3_set_clientdata(p1: Psqlite3; const p2: PUTF8Char; p3: Pointer; p4: sqlite3_set_clientdata_): Integer; cdecl;
  external bj name _PU + 'sqlite3_set_clientdata';
...
type
  Tsqlite3_compare_callback = function(pArg: Pointer; nBytes1: Integer;
    const eTextRep1: Pointer; nBytes2: Integer; const eTextRep2: Pointer): Integer; cdecl;

function sqlite3_create_collation(p1: Psqlite3; const zName: PUTF8Char; eTextRep: Integer; pArg: Pointer; xCompare: Tsqlite3_compare_callback): Integer; cdecl;
  external bj name _PU + 'sqlite3_create_collation';



function sqlite3_create_collation_v2(p1: Psqlite3; const zName: PUTF8Char;
  eTextRep: Integer; pArg: Pointer; xCompare: Tsqlite3_compare_callback;
  xDestroy: TSQLite3_Destroy_Callback): Integer; cdecl;
  external bj name _PU + 'sqlite3_create_collation_v2';


function sqlite3_create_collation16(p1: Psqlite3; const zName: Pointer; eTextRep: Integer; pArg: Pointer; xCompare: Tsqlite3_compare_callback): Integer; cdecl;
  external bj name _PU + 'sqlite3_create_collation16';

type
  Tsqlite3_collneeded_callback = procedure(pArg: Pointer; db: Psqlite3; eTextRep: Integer; const collation_name: PUTF8Char); cdecl;

function sqlite3_collation_needed(p1: Psqlite3; p2: Pointer; p3: Tsqlite3_collneeded_callback): Integer; cdecl;
  external bj name _PU + 'sqlite3_collation_needed';

type
  Tsqlite3_collneeded16_callback = procedure(pArg: Pointer; db: Psqlite3; eTextRep: Integer; const collation_name: Pointer); cdecl;

function sqlite3_collation_needed16(p1: Psqlite3; p2: Pointer; p3: Tsqlite3_collneeded16_callback): Integer; cdecl;
...
type
  Tsqlite3_commithook_callback = function(ptr: Pointer): Integer; cdecl;

function sqlite3_commit_hook(p1: Psqlite3; p2: Tsqlite3_commithook_callback; p3: Pointer): Pointer; cdecl;
...
type
  Tsqlite3_updatehook_callback = procedure(pArg: Pointer; invoked: Integer; const database_name: PUTF8Char; const table_name: PUTF8Char; rowid: sqlite3_int64); cdecl;

function sqlite3_update_hook(p1: Psqlite3; p2: Tsqlite3_updatehook_callback; p3: Pointer): Pointer; cdecl;
...
type
  Tsqlite3_entrypoint_callback = procedure(); cdecl;

function sqlite3_auto_extension(xEntryPoint: Tsqlite3_entrypoint_callback): Integer; cdecl;
  external bj name _PU + 'sqlite3_auto_extension';

type
  Tsqlite3_cancelentrypoint_callback = procedure(); cdecl;

function sqlite3_cancel_auto_extension(xEntryPoint: Tsqlite3_cancelentrypoint_callback): Integer; cdecl;
...
type
  Tsqlite3_unlocknotify_callback = procedure(apArg: PPointer; nArg: Integer); cdecl;

function sqlite3_unlock_notify(pBlocked: Psqlite3; xNotify: Tsqlite3_unlocknotify_callback; pNotifyArg: Pointer): Integer; cdecl;
...
type
  Tsqlite3_walhook_callback = function(pArg: Pointer; db: Psqlite3; const zDbName: PUTF8Char;
    nEntry: Integer): Integer; cdecl;

function sqlite3_wal_hook(p1: Psqlite3; p2: Tsqlite3_walhook_callback; p3: Pointer): Pointer; cdecl;
...
type
  Tsqlite3_preupdate_callback = procedure(pCtx: Pointer; db: Psqlite3; op: Integer; const zDb: PUTF8Char; const zName: PUTF8Char; iKey1: sqlite3_int64; iKey2: sqlite3_int64); cdecl;
function sqlite3_preupdate_hook(db: Psqlite3; xPreUpdate: Tsqlite3_preupdate_callback; p3: Pointer): Pointer; cdecl;
  external bj name _PU + 'sqlite3_preupdate_hook';
function sqlite3_preupdate_old(p1: Psqlite3; p2: Integer; p3: PPsqlite3_value): Integer; cdecl;
  external bj name _PU + 'sqlite3_preupdate_old';
function sqlite3_preupdate_count(p1: Psqlite3): Integer; cdecl;
  external bj name _PU + 'sqlite3_preupdate_count';
function sqlite3_preupdate_depth(p1: Psqlite3): Integer; cdecl;
  external bj name _PU + 'sqlite3_preupdate_depth';
function sqlite3_preupdate_new(p1: Psqlite3; p2: Integer; p3: PPsqlite3_value): Integer; cdecl;
  external bj name _PU + 'sqlite3_preupdate_new';
function sqlite3_preupdate_blobwrite(p1: Psqlite3): Integer; cdecl;
  external bj name _PU + 'sqlite3_preupdate_blobwrite';
...
type
  Tsqlite3_rtreegeometry_callback = function(pArg: Psqlite3_rtree_geometry; nCoord: Integer; aCoord: Psqlite3_rtree_dbl; eWithin: PInteger): Integer; cdecl;

function sqlite3_rtree_geometry_callback(db: Psqlite3; const zGeom: PUTF8Char; xGeom: Tsqlite3_rtreegeometry_callback; pContext: Pointer): Integer; cdecl;
...
function sqlite3session_create(db: Psqlite3; const zDb: PUTF8Char; ppSession: PPsqlite3_session): Integer; cdecl;
  external bj name _PU + 'sqlite3session_create';
procedure sqlite3session_delete(pSession: Psqlite3_session); cdecl;
  external bj name _PU + 'sqlite3session_delete';
function sqlite3session_object_config(p1: Psqlite3_session; op: Integer; pArg: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3session_object_config';
function sqlite3session_enable(pSession: Psqlite3_session; bEnable: Integer): Integer; cdecl;
  external bj name _PU + 'sqlite3session_enable';
function sqlite3session_indirect(pSession: Psqlite3_session; bIndirect: Integer): Integer; cdecl;
  external bj name _PU + 'sqlite3session_indirect';
function sqlite3session_attach(pSession: Psqlite3_session; const zTab: PUTF8Char): Integer; cdecl;
  external bj name _PU + 'sqlite3session_attach';
type
  Tsqlite3session_filter_callback = function(pCtx: Pointer; const zTab: PUTF8Char): Integer; cdecl;

procedure sqlite3session_table_filter(pSession: Psqlite3_session; xFilter: Tsqlite3session_filter_callback; pCtx: Pointer); cdecl;
  external bj name _PU + 'sqlite3session_table_filter';
function sqlite3session_changeset(pSession: Psqlite3_session; pnChangeset: PInteger; ppChangeset: PPointer): Integer; cdecl;
  external bj name _PU + 'sqlite3session_changeset';
function sqlite3session_changeset_size(pSession: Psqlite3_session): sqlite3_int64; cdecl;
  external bj name _PU + 'sqlite3session_changeset_size';
function sqlite3session_diff(pSession: Psqlite3_session; const zFromDb: PUTF8Char; const zTbl: PUTF8Char; pzErrMsg: PPUTF8Char): Integer; cdecl;
  external bj name _PU + 'sqlite3session_diff';
function sqlite3session_patchset(pSession: Psqlite3_session; pnPatchset: PInteger; ppPatchset: PPointer): Integer; cdecl;
  external bj name _PU + 'sqlite3session_patchset';
function sqlite3session_isempty(pSession: Psqlite3_session): Integer; cdecl;
  external bj name _PU + 'sqlite3session_isempty';
function sqlite3session_memory_used(pSession: Psqlite3_session): sqlite3_int64; cdecl;
  external bj name _PU + 'sqlite3session_memory_used';
function sqlite3changeset_start(pp: PPsqlite3_changeset_iter; nChangeset: Integer; pChangeset: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_start';
function sqlite3changeset_start_v2(pp: PPsqlite3_changeset_iter; nChangeset: Integer; pChangeset: Pointer; flags: Integer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_start_v2';
function sqlite3changeset_next(pIter: Psqlite3_changeset_iter): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_next';
function sqlite3changeset_op(pIter: Psqlite3_changeset_iter; pzTab: PPUTF8Char; pnCol: PInteger; pOp: PInteger; pbIndirect: PInteger): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_op';
function sqlite3changeset_pk(pIter: Psqlite3_changeset_iter; pabPK: PPByte; pnCol: PInteger): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_pk';
function sqlite3changeset_old(pIter: Psqlite3_changeset_iter; iVal: Integer; ppValue: PPsqlite3_value): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_old';
function sqlite3changeset_new(pIter: Psqlite3_changeset_iter; iVal: Integer; ppValue: PPsqlite3_value): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_new';
function sqlite3changeset_conflict(pIter: Psqlite3_changeset_iter; iVal: Integer; ppValue: PPsqlite3_value): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_conflict';
function sqlite3changeset_fk_conflicts(pIter: Psqlite3_changeset_iter; pnOut: PInteger): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_fk_conflicts';
function sqlite3changeset_finalize(pIter: Psqlite3_changeset_iter): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_finalize';
function sqlite3changeset_invert(nIn: Integer; const pIn: Pointer; pnOut: PInteger; ppOut: PPointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_invert';
function sqlite3changeset_concat(nA: Integer; pA: Pointer; nB: Integer; pB: Pointer; pnOut: PInteger; ppOut: PPointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_concat';
function sqlite3changeset_upgrade(db: Psqlite3; const zDb: PUTF8Char; nIn: Integer; const pIn: Pointer; pnOut: PInteger; ppOut: PPointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_upgrade';
function sqlite3changegroup_new(pp: PPsqlite3_changegroup): Integer; cdecl;
  external bj name _PU + 'sqlite3changegroup_new';
function sqlite3changegroup_schema(p1: Psqlite3_changegroup; p2: Psqlite3; const zDb: PUTF8Char): Integer; cdecl;
  external bj name _PU + 'sqlite3changegroup_schema';
function sqlite3changegroup_add(p1: Psqlite3_changegroup; nData: Integer; pData: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changegroup_add';
function sqlite3changegroup_add_change(p1: Psqlite3_changegroup; p2: Psqlite3_changeset_iter): Integer; cdecl;
  external bj name _PU + 'sqlite3changegroup_add_change';
function sqlite3changegroup_output(p1: Psqlite3_changegroup; pnData: PInteger; ppData: PPointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changegroup_output';
procedure sqlite3changegroup_delete(p1: Psqlite3_changegroup); cdecl;
  external bj name _PU + 'sqlite3changegroup_delete';
type
  Tsqlite3changeset_filter_callback = function(pCtx: Pointer; const zTab: PUTF8Char): Integer; cdecl;
type
  sqlite3changeset_apply_xConflict = function(pCtx: Pointer; eConflict: Integer; p: Psqlite3_changeset_iter): Integer; cdecl;
function sqlite3changeset_apply(db: Psqlite3; nChangeset: Integer; pChangeset: Pointer; xFilter: Tsqlite3changeset_filter_callback; xConflict: sqlite3changeset_apply_xConflict; pCtx: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_apply';
type
  sqlite3changeset_apply_v2_xFilter = function(pCtx: Pointer; const zTab: PUTF8Char): Integer; cdecl;
type
  sqlite3changeset_apply_v2_xConflict = function(pCtx: Pointer; eConflict: Integer; p: Psqlite3_changeset_iter): Integer; cdecl;
function sqlite3changeset_apply_v2(db: Psqlite3; nChangeset: Integer; pChangeset: Pointer; xFilter: sqlite3changeset_apply_v2_xFilter; xConflict: sqlite3changeset_apply_v2_xConflict; pCtx: Pointer; ppRebase: PPointer; pnRebase: PInteger; flags: Integer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_apply_v2';
function sqlite3rebaser_create(ppNew: PPsqlite3_rebaser): Integer; cdecl;
  external bj name _PU + 'sqlite3rebaser_create';
function sqlite3rebaser_configure(p1: Psqlite3_rebaser; nRebase: Integer; const pRebase: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3rebaser_configure';
function sqlite3rebaser_rebase(p1: Psqlite3_rebaser; nIn: Integer; const pIn: Pointer; pnOut: PInteger; ppOut: PPointer): Integer; cdecl;
  external bj name _PU + 'sqlite3rebaser_rebase';
procedure sqlite3rebaser_delete(p: Psqlite3_rebaser); cdecl;
  external bj name _PU + 'sqlite3rebaser_delete';
type
  sqlite3changeset_apply_strm_xInput = function(pIn: Pointer; pData: Pointer; pnData: PInteger): Integer; cdecl;
type
  sqlite3changeset_apply_strm_xFilter = function(pCtx: Pointer; const zTab: PUTF8Char): Integer; cdecl;
type
  sqlite3changeset_apply_strm_xConflict = function(pCtx: Pointer; eConflict: Integer; p: Psqlite3_changeset_iter): Integer; cdecl;
function sqlite3changeset_apply_strm(db: Psqlite3; xInput: sqlite3changeset_apply_strm_xInput; pIn: Pointer; xFilter: sqlite3changeset_apply_strm_xFilter; xConflict: sqlite3changeset_apply_strm_xConflict; pCtx: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_apply_strm';
type
  sqlite3changeset_apply_v2_strm_xInput = function(pIn: Pointer; pData: Pointer; pnData: PInteger): Integer; cdecl;
type
  sqlite3changeset_apply_v2_strm_xFilter = function(pCtx: Pointer; const zTab: PUTF8Char): Integer; cdecl;
type
  sqlite3changeset_apply_v2_strm_xConflict = function(pCtx: Pointer; eConflict: Integer; p: Psqlite3_changeset_iter): Integer; cdecl;
function sqlite3changeset_apply_v2_strm(db: Psqlite3; xInput: sqlite3changeset_apply_v2_strm_xInput; pIn: Pointer; xFilter: sqlite3changeset_apply_v2_strm_xFilter; xConflict: sqlite3changeset_apply_v2_strm_xConflict; pCtx: Pointer; ppRebase: PPointer; pnRebase: PInteger; flags: Integer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_apply_v2_strm';
type
  sqlite3changeset_concat_strm_xInputA = function(pIn: Pointer; pData: Pointer; pnData: PInteger): Integer; cdecl;
type
  sqlite3changeset_concat_strm_xInputB = function(pIn: Pointer; pData: Pointer; pnData: PInteger): Integer; cdecl;
type
  sqlite3changeset_concat_strm_xOutput = function(pOut: Pointer; const pData: Pointer; nData: Integer): Integer; cdecl;
function sqlite3changeset_concat_strm(xInputA: sqlite3changeset_concat_strm_xInputA; pInA: Pointer; xInputB: sqlite3changeset_concat_strm_xInputB; pInB: Pointer; xOutput: sqlite3changeset_concat_strm_xOutput; pOut: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_concat_strm';
type
  sqlite3changeset_invert_strm_xInput = function(pIn: Pointer; pData: Pointer; pnData: PInteger): Integer; cdecl;
type
  sqlite3changeset_invert_strm_xOutput = function(pOut: Pointer; const pData: Pointer; nData: Integer): Integer; cdecl;
function sqlite3changeset_invert_strm(xInput: sqlite3changeset_invert_strm_xInput; pIn: Pointer; xOutput: sqlite3changeset_invert_strm_xOutput; pOut: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_invert_strm';
type
  sqlite3changeset_start_strm_xInput = function(pIn: Pointer; pData: Pointer; pnData: PInteger): Integer; cdecl;
function sqlite3changeset_start_strm(pp: PPsqlite3_changeset_iter; xInput: sqlite3changeset_start_strm_xInput; pIn: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_start_strm';
type
  sqlite3changeset_start_v2_strm_xInput = function(pIn: Pointer; pData: Pointer; pnData: PInteger): Integer; cdecl;
function sqlite3changeset_start_v2_strm(pp: PPsqlite3_changeset_iter; xInput: sqlite3changeset_start_v2_strm_xInput; pIn: Pointer; flags: Integer): Integer; cdecl;
  external bj name _PU + 'sqlite3changeset_start_v2_strm';
type
  sqlite3session_changeset_strm_xOutput = function(pOut: Pointer; const pData: Pointer; nData: Integer): Integer; cdecl;
function sqlite3session_changeset_strm(pSession: Psqlite3_session; xOutput: sqlite3session_changeset_strm_xOutput; pOut: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3session_changeset_strm';
type
  sqlite3session_patchset_strm_xOutput = function(pOut: Pointer; const pData: Pointer; nData: Integer): Integer; cdecl;
function sqlite3session_patchset_strm(pSession: Psqlite3_session; xOutput: sqlite3session_patchset_strm_xOutput; pOut: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3session_patchset_strm';
type
  sqlite3changegroup_add_strm_xInput = function(pIn: Pointer; pData: Pointer; pnData: PInteger): Integer; cdecl;
function sqlite3changegroup_add_strm(p1: Psqlite3_changegroup; xInput: sqlite3changegroup_add_strm_xInput; pIn: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changegroup_add_strm';
type
  sqlite3changegroup_output_strm_xOutput = function(pOut: Pointer; const pData: Pointer; nData: Integer): Integer; cdecl;
function sqlite3changegroup_output_strm(p1: Psqlite3_changegroup; xOutput: sqlite3changegroup_output_strm_xOutput; pOut: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3changegroup_output_strm';
type
  sqlite3rebaser_rebase_strm_xInput = function(pIn: Pointer; pData: Pointer; pnData: PInteger): Integer; cdecl;
type
  sqlite3rebaser_rebase_strm_xOutput = function(pOut: Pointer; const pData: Pointer; nData: Integer): Integer; cdecl;
function sqlite3rebaser_rebase_strm(pRebaser: Psqlite3_rebaser; xInput: sqlite3rebaser_rebase_strm_xInput; pIn: Pointer; xOutput: sqlite3rebaser_rebase_strm_xOutput; pOut: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3rebaser_rebase_strm';
function sqlite3session_config(op: Integer; pArg: Pointer): Integer; cdecl;
  external bj name _PU + 'sqlite3session_config';
type
...
function sqlite3_key(DB: sqlite3_ptr; pKey: PAnsiChar; nKey: Integer): Integer; cdecl;
  external bj name _PU + 'sqlite3_key';
function sqlite3_key_v2(DB: sqlite3_ptr; zDbName: PAnsiChar; pKey: PAnsiChar; nKey: Integer): Integer; cdecl;
  external bj name _PU + 'sqlite3_key_v2';
function sqlite3_rekey(DB: sqlite3_ptr; pKey: PAnsiChar; nKey: Integer): Integer; cdecl;
  external bj name _PU + 'sqlite3_rekey';
function sqlite3_rekey_v2(DB: sqlite3_ptr; zDbName: PAnsiChar; pKey: PAnsiChar; nKey: Integer): Integer; cdecl;
  external bj name _PU + 'sqlite3_rekey_v2';
